...
SR_img = output_.numpy()
SR_img = np.reshape(SR_img, (255, 255))

misc.imsave('image/butterfly_LR.bmp',LR_image)
misc.imsave('image/butterfly_HR.bmp',HR_image)
misc.imsave('./image/butterfly_SR.bmp', SR_img)

print("LR-HR psnr:{}".format(peak_signal_noise_ratio(LR_image, HR_image)))
print("SR-HR psnr:{}".format(peak_signal_noise_ratio(SR_img, HR_image)))
